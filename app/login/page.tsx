            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full py-3 px-4 bg-[#06C755] hover:bg-[#05b34c] text-white font-semibold rounded-lg transition-all duration-200 flex items-center justify-center space-x-3 shadow-md active:scale-[0.98]"
                    >
                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                            <path d="M24 10.304c0-5.369-5.383-9.738-12-9.738-6.616 0-12 4.369-12 9.738 0 4.814 4.269 8.846 10.036 9.608.391.084.922.258 1.058.59.12.301.079.766.038 1.08l-.164 1.02c-.045.301-.24 1.186 1.049.645 1.291-.539 6.916-4.074 9.436-6.975 1.742-2.126 2.547-3.95 2.547-5.968z" />
                        </svg>
                        <span>LINEでログイン</span>
                    </button>
