...
export default function Home() {
    ...
    return (
        <div className="flex h-screen bg-[#121212] overflow-hidden">
            {/* Sidebar */}
            <aside className={`bg-[#1a1a1a] border-r border-gray-800 flex flex-col flex-shrink-0 z-10 transition-all duration-300 ${isSidebarCollapsed ? 'w-20' : 'w-64'}`}>
                <div className={`p-6 h-full flex flex-col ${isSidebarCollapsed ? 'items-center' : ''}`}>
                    ...
                    {!isSidebarCollapsed && profile && (
                        <div className="flex items-center space-x-3 mb-10 px-2 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => { resetToHome(); setShowProfileDisplay(true); }}>
